    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        <motion.div
          ...
          className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-white"
        >
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            ...
            <div className="text-right">
              ...
              <p className="text-xl sm:text-2xl font-bold">{formatCurrency(categoryStats.totalIncome)}</p>
            </div>
          </div>
        ...
        <motion.div
          ...
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.5 }}
          className="bg-gradient-to-r from-red-500 to-pink-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 text-white"
        >
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white bg-opacity-20 rounded-lg sm:rounded-xl flex items-center justify-center">
            ...
            <div className="text-right">
              ...
              <p className="text-xl sm:text-2xl font-bold">{formatCurrency(categoryStats.totalExpenses)}</p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm">
          <div className="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6">
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-green-100 dark:bg-green-900 rounded-lg sm:rounded-xl flex items-center justify-center">
              <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5 text-green-600 dark:text-green-400" />
            </div>
            <div>
              <h3 className="text-base sm:text-lg font-bold text-gray-900 dark:text-white">Income by Category</h3>
          ...
          <div className="space-y-3 sm:space-y-4">
            {categoryStats.incomeCategories.length > 0 ? (
              ...
              <div className="text-center py-6 sm:py-8 text-gray-500 dark:text-gray-400">
                ...
                <p className="text-sm">No income transactions this month</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm">
          <div className="flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6">
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-red-100 dark:bg-red-900 rounded-lg sm:rounded-xl flex items-center justify-center">
              <TrendingDown className="w-4 h-4 sm:w-5 sm:h-5 text-red-600 dark:text-red-400" />
            </div>
            <div>
              <h3 className="text-base sm:text-lg font-bold text-gray-900 dark:text-white">Expenses by Category</h3>
              <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">
                {format(new Date(), 'MMMM yyyy')}
              </p>
            </div>
