...
const TransactionModal: React.FC<TransactionModalProps> = ({
  ...
  const filteredCategories = categories
    ...
    .filter((cat, index, self) => self.findIndex(c => c.name === cat.name) === index) // Remove duplicates
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-2 sm:p-4 z-50">
          <motion.div
            ...
            className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 w-full max-w-md max-h-[95vh] sm:max-h-[90vh] overflow-y-auto"
          >
